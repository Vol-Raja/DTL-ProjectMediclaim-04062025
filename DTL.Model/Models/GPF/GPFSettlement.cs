...
namespace DTL.Model.Models.GPF
{
    public class GPF_Settlement
    {
        ...
        public bool? LifeTimePension { get; set; }
        public string? LifeTimePensionReason { get; set; }
        ...
        [NotMapped]
        public IEnumerable<GPF_Settlement_Nominee> Nominees { get; set; }
        [NotMapped]
        public GPF_Settlement_BankDetails BankDetails { get; set; }
        [NotMapped]
        public IEnumerable<GPF_Settlement_Documents> Documents { get; set; }
        [NotMapped]
        public GPFEmployeeDetail Employee { get; set; }
    }

    public class GPF_Settlement_View : GPF_Settlement
    {
    ...
    public class GPF_Settlement_View_Disburs : GPF_Settlement_View
    {
    ...
    public class GPF_Settlement_BankDetails
    {
        [Key]
        public int Id { get; set; }
        public string ApplicationNumber { get; set; }
    ...
    public class GPF_Settlement_Nominee
    {
        [Key]
        public int Id { get; set; }
        public string ApplicationNumber { get; set; }
    ...
    public class GPF_Settlement_Documents
    {
        [Key]
        public int Id { get; set; }
        public string ApplicationNumber { get; set; }
