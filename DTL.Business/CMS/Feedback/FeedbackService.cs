...
namespace DTL.Business.CMS.Feedback
{
    public class FeedbackService : IFeedbackService
    {
        ...
        public FeedbackService(IDapperService dapper)
        {
            _dapper = dapper;
        ...
        public string AddEditFeedbackData(FeedbackModel model, bool isEdit)
        {
            ...
            dbparams.Add("@Details", model.Details, DbType.String);
            ...
            _dapper.Execute("AddEditFeedback", dbparams);
        ...
        public IEnumerable<FeedbackModel> GetFeedbackModelByParam(Guid? Id, bool? IsDeleted)
        {
            ...
            return _dapper.GetAll<FeedbackModel>("GetFeedbackByParam", dbparams);
        }
