...
namespace DTL.Business.CMS.Event
{
    public class EventService : IEventService
    {
        ...
        public EventService(IDapperService dapper)
        {
            _dapper = dapper;
        ...
        public string AddEditEventData(EventModel model, bool isEdit)
        {
            ...
            dbparams.Add("@EventDate", model.EventDate, DbType.DateTime);
            ...
            _dapper.Execute("AddEditEvent", dbparams);
        ...
        public IEnumerable<EventModel> GetEventModelByParam(Guid? Id, bool? IsDeleted)
        {
            ...
            return _dapper.GetAll<EventModel>("GetEventByParam", dbparams);
        }
