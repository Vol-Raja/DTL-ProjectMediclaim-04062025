...
namespace DTL.Business.CMS.Notice
{
    public class NoticeService : INoticeService
    {
        ...
        public NoticeService(IDapperService dapper)
        {
            _dapper = dapper;
        ...
        public string AddEditNoticeData(NoticeModel model, bool isEdit)
        {
            ...
            dbparams.Add("@NoticeDate", model.NoticeDate, DbType.DateTime);
            dbparams.Add("@NoticeDateHindi", model.NoticeDateHindi, DbType.DateTime);
            ...
            _dapper.Execute("AddEditNotice", dbparams);
        ...
        public IEnumerable<NoticeModel> GetNoticeModelByParam(Guid? Id, bool? IsDeleted, bool? IsArchieved)
        {
            ...
            return _dapper.GetAll<NoticeModel>("GetNoticeByParam", dbparams);
        }
