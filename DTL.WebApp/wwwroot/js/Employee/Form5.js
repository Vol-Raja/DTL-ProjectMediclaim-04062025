...
function AddEditForm() {
    $.validator.setDefaults({
        submitHandler: function () {
            ...
            $.ajax({
                url: "/EmployeeRegistration/CreateForm5",
                type: "POST",
                dataType: "json",
                data: formData,
                contentType: false,
...
$("#viewAadharDoc").click(function () {
    getFile("aadhar", $("#EmployeeRegistrationId").val())
});

$("#viewPanDoc").click(function () {
    getFile("pan", $("#EmployeeRegistrationId").val())
});

function getFile(fileName, employeeId) {
    $.ajax({
