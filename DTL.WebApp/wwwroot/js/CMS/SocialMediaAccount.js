$(document).ready(function () {
    ...
    $('#btnSubmit').click(function (e) {
        e.preventDefault();
        if ($("#AddSocialMediaAccountForm").valid() == false)
            return false;
        let IsNew = $("#IsNew").val();
        ...
        showConfirmSwal(msg, function () {
            var url = '/WebsiteCMS/SocialMediaAccount/Save';
            ...
            $.ajax({
                ...
                success: function (response, status, xhr) {
                    ...
                    setTimeout(function () {
                        window.location.href = '/WebsiteCMS/SocialMediaAccount';
                    }, 2000);
                },
...
function BindAddSocialMediaAccountFormData() {
    var frm = $('#AddSocialMediaAccountForm');
