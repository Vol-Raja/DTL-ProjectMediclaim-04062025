$(document).ready(function () {
    ...
    $('#btnSubmit').click(function (e) {
        ...
        showConfirmSwal(msg, function () {
            var url = '/WebsiteCMS/Notice/Save';
            var formData = BindAddNoticeFormData();
            showLoader()
            $.ajax({
                ...
                success: function (response, status, xhr) {
                    ...
                    setTimeout(function () {
                        window.location.href = '/WebsiteCMS/Notice';
                    }, 2000);
                },
...
function BindAddNoticeFormData() {
    var frm = $('#AddNoticeForm');
...
$('#AddNoticeForm').validate({
    ...
    messages: {
        ...
        NoticeDate: {
            required: "Please provide Notice Date.",
        }
        ,
        AttachmentTitleInEnglish: {
            required: "Please provide Title In English.",
...
$("#Notice_date").on("change", function () {
    $(this).removeClass('is-invalid');
    $("#NoticeDate-error").css('display', 'None');
});
...
$(document).ready(function () {
    let id = $("#ID").val();
    let url = '/WebsiteCMS/Notice/DownloadFile/' + id;
