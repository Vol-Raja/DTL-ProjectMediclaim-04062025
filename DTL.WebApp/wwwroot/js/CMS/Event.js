$(document).ready(function () {
    ...
    $('#btnSubmit').click(function (e) {
        ...
        showConfirmSwal(msg, function () {
            var url = '/WebsiteCMS/Event/Save';
            var formData = BindAddEventFormData();
            ...
            $.ajax({
                ...
                success: function (response, status, xhr) {
                    ...
                    setTimeout(function () {
                        window.location.href = '/WebsiteCMS/Event';
                    }, 2000);
                },
...
$(document).ready(function () {
    let id = $("#ID").val();
    let url = '/WebsiteCMS/Event/DownloadFile/' + id;
